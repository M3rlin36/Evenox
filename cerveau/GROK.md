...
9. Si le client **conteste** une règle (dépôt, NET, livraison gratuite) : ne pas réciter la règle comme si c’était réglé — poser la question.
...
Tél invalide ou manquant · NET 60 · NET 30 sans OK Alexandre · « 95 % » / quasi-oui · changement d’entité / qui facture · sans dépôt · hold · PJ ≠ courriel · année absente · jour ≠ calendrier · portée périmée · produit que nous nommons et pas le client · total sans lignes
...
- Jamais dans un mail de questions.
- Jamais inventés. Jamais repris du bas d’un fil périmé.
- Pas de total sans ventilation (lignes).
...
- Prix dans le mail de questions
