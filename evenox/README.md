...
La page Divi (hero, photos, kit, couleurs `#5E17EB`, Raleway) reste. Le plugin 1.1.1 n’injecte que dans `#evx-plan` s’il existe. Sans cet hôte, le calculateur d’origine (déjà en étapes) s’affiche.
