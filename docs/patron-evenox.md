...
- Courriel = TRI. 0 envoi. File Gmail `GROS-File` / `NOX-À-traiter`. Brouillons seulement.
...
L’UI xAI Grok n’est pas éditable ici. Coller le bloc ci-dessus dans Grok Bot.
