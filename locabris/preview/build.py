...
write(
    "simples.html",
    "Abris simples 11 et 12 pieds | Locabris",
    MOD.joinpath("simples.html").read_text(encoding="utf-8"),
    "simples",
)
write(
    "doubles.html",
...
<div class="chrome-hub">
  ...
  <a class="chrome-card" href="soumission.html"><strong>Soumission</strong><span>Kit Evenox : étapes, quantités, panier, merci seulement après envoi.</span></a>
